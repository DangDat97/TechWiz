                            ...
                            <div class="ltn__shop-details-img-gallery ltn__shop-details-img-gallery-2">
                                ...
                                <div class="ltn__shop-details-large-img">
                                    <div class="single-large-img">
                                        <a href="{{$accessory->image}}" data-rel="lightcase:myCollection">
                                            <img src="{{$accessory->image}} "alt="Image">
                                        </a>
                                    </div>
                                </div>
                            </div>
            ...
            <div class="col-12">
                <div class="ltn__product-item ltn__product-item-4">
                    <div class="product-img">
                        <a href=""><img src="{{$access->image}}" style="max-width: 263px ; height: 342px" alt="#"></a>
